...
# 4章: 人の管理
人の管理で求められる主な仕事は以下の4つ
- 直属の部下との関係の構築
- 定期的な1on1MTG
- キャリアアップや作業の進捗状況、改善領域、成績の報奨などに関するフィードバック
- 各メンバーの研鑽を要する領域の見極めとその領域の能力強化

## 4-1 直属の上下関係
相手を理解するための質問 - 中でも、その人の管理をやりやすくしてくれる質問 - をする
- 優れた功績や言動などに関して褒められる場合、人前でも構いませんか、それとも１対１の方が良いですか
- 重要なフィードバックはどういった伝え方を希望するか(じっくり検討できる書面でのフィードバックかあまり形式張らない口頭でのフィードバックがいいですか)
- この部署で仕事をしようと思った理由はなんですか
- 不機嫌なとき、どんな感じになるか。何が嫌いですか
- 耐え難いと思う上司の振る舞いがあれば教えてください
- キャリアアップの明確な目標があるか
- このチームに来てから、何か自分に言っておきたいことがあるか
- 最初の三ヶ月間、チームに関する感想や意見を新人にできるだけ多く表明してもらう

## 4-2 チームメンバーとのコミュニケーション
- 1-1は週一がやはり適切

## 4-3 1-1の進め方
- TODOリストを持ち寄り、重要なものから順に提起していく
    - 有意義なトピックをリストアップする
- 同僚を侮辱した等の空海のためのフィードバックが直ちに必要な場合はできる限りすぐに1-1を開く

## 4-4 すごい上司、ひどい上司
- 細部まで厳しく管理して部下に最旅券を与えない微細管理はどの管理者でも陥りがちな落とし穴
- 最大の難問は「マイクロマネジメントが必要な場合もある」
    - マイクロマネジメントの確信は「信頼」と「管理」
- 一方、「委任」は「放任」とは違う
    - プロジェクトを成功させるために、必要に応じて関与し、後押しすべき

## 4-5 効率よく仕事を任せるために -- 実践的アドバイス
- 優れたリーダーとは任せ上手であるということを忘れない

## 4-6 「継続的なフィードバックの文化」をチームに根付かせる
- 評価の時期にフィードバックするのではなく、日頃から功績の報奨や問題点の指摘を積極的に続けることが望ましい

### 継続的なフィードバックを実践する上で有効な対策
1. 部下の基本情報を仕入れる
2. 日頃から部下を見守る習慣を
3. 深刻な話題も日常レベルのフィードバックで「さらり」と

## 4-9 やりにくい仕事 -- 成績不振者の解雇 --
- 成績の振るわない部下に徹底したコーチングをするべき
    - ぐずぐずせず、かつ頻繁に、「期待されているレベルの仕事ができていないこと」をはっきり知らせる

# 5章: チームの管理
- 優れた管理者になる上で何よりも大切なのは最強の技術力の持ち主であることではない

## 5-1 ITスキルの維持
- 頑張ってコード下記の作業は多少なりとも続ける

## 5-2 機能不全に陥ったチームのデバッグの基本
- 言葉遣いに配慮できない部下を長い間放置しておいてはならない
    - チームのエネルギーを吸い取り枯渇させてしまう
